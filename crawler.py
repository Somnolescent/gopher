...
settings = {
    'limit_host': 'gopher.somnolescent.net',  # Host to limit to (for indexing single servers, which is highly recommended)
    ...
    'crawl_url': 'gopher://gopher.somnolescent.net/1/',  # URL to crawl (after finished updating the index)
